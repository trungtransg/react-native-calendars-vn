...
export const textSunSectionTitleColor = '#b6c1cd';
export const textSatSectionTitleColor = '#b6c1cd';
...
export const daySunTextColor = textDefaultColor;
export const daySatTextColor = textDefaultColor;
...
export const agendaDayTextColor = 'green'; //'#7a92a5';
export const agendaDayNumColor = 'green'; //'#7a92a5';
